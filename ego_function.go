...
import (
	...
	"github.com/eezz10001/ego/core/esentinel"

	sentinelMetrics "github.com/alibaba/sentinel-golang/metrics"

	"github.com/eezz10001/ego/core/constant"
	...
	"github.com/eezz10001/ego/core/etrace/otel"
	"github.com/eezz10001/ego/core/util/xcolor"
)
...
func (e *Ego) printBanner() error {
 ...
 |  _ \(_)_ __   ___| | | | \ | |_   _|  ___| | _____      __
 | |_) | | '_ \ / _ \ | | |  \| | | | | |_  | |/ _ \ \ /\ / /
 |  __/| | | | |  __/ |_| | |\  | | | |  _| | | (_) \ V  V /
 |_|   |_|_| |_|\___|\___/|_| \_| |_| |_|   |_|\___/ \_/\_/

Welcome to PineUNTFlow, starting application ...
`
